...
public class StandardizedLogLineFilterProcessor {
    ...
    public boolean shouldLineActionTypeBeLoggedForThisTask(Exchange exchange) {
        log.debug("LogLineFilterProcessor called for logfile: {}, line: {}", exchange.getMessage().getHeader(LOG_FILENAME), exchange.getVariable(PLACE_IN_PACKET));
