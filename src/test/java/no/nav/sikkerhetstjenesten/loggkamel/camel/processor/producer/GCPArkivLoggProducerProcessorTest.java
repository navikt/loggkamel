...
import static no.nav.sikkerhetstjenesten.loggkamel.camel.processor.producer.GCPArkivLoggProducerProcessor.CLOUD_LOGGING_ENTRY_NAME;
...
class GCPArkivLoggProducerProcessorTest {
    ...
    @InjectMocks
    private GCPArkivLoggProducerProcessor processor;
