...
class LogLineMessageConsumerProcessorTest {
    ...
    @InjectMocks
    private LogLineMessageConsumerProcessor processor;
    ...
    @Test
    void mapToAuditloggLineMessage_setsBodyAndVariables() throws Exception {
        Exchange exchange = new DefaultExchange(new DefaultCamelContext());
        ...
        assertInstanceOf(AuditloggLineMessage.class, exchange.getMessage().getBody());
        assertEquals(auditloggLineMessage, exchange.getMessage().getBody(AuditloggLineMessage.class));
