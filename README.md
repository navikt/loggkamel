...
This project was developed with the assistance of GitHub Copilot, an AI-powered code completion tool. Architecture and goals
are set by humans, and implementation is carefully reviewed before use.

## Open-Source Contributions

This service is open-source, and suggestions and other contributions are welcome!